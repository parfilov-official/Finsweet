...
<section class="about-us-top-section">
  <div class="container about-us-top-section__container">
    <div class="about-us-top-section__top-wrapper">
      <div class="about-us-top-section__top-text-block">
        <h1 class="about-us-top-section__main-title title">ABOUT US</h1>
        <h2 class="about-us-top-section__title">
          We are a team of content writers who share their learnings
        </h2>
      </div>
      <p class="about-us-top-section__text">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
      </p>
    </div>
    <div class="about-us-top-section__wrapper">
      <div class="about-us-top-section__img">
        <img src="<?php the_field('about-us-top-img1'); ?>" alt="">
      </div>
      <div class="about-us-top-section__bottom-text-block">
        <div class="about-us-top-section-stats">
          <ul class="about-us-top-section-stats__list">
            <li class="about-us-top-section-stats__item">
              <span class="about-us-top-section-stats__numbers">12+</span>
              Blogs Published
            </li>
            <li class="about-us-top-section-stats__item">
              <span class="about-us-top-section-stats__numbers">18K+</span>
              Views on Finsweet
            </li>
            <li class="about-us-top-section-stats__item">
              <span class="about-us-top-section-stats__numbers">30K+</span>
              Total active Users
            </li>
          </ul>
        </div>
        <div class="about-us-top-section-text">
          <div class="about-us-top-section-text__block">
            <h3 class="about-us-top-section-text__main-title title">Our mision</h3>
            <h4 class="about-us-top-section-text__title">
              Creating valuable content for creatives all around the world
            </h4>
            <p class="about-us-top-section-text__text">
          ...
          <div class="about-us-top-section-text__block">
            <h3 class="about-us-top-section-text__main-title title">Our Vision</h3>
            <h4 class="about-us-top-section-text__title">
  ...
  <div class="container about-us__container">
    <div class="about-us__wrapper">
      ...
      <div class="about-us__img">
        <img src="<?php the_field('about-us-top-img2'); ?>" alt="">
      </div>
    </div>
    <div class="about-us__wrapper">
      <div class="about-us__text-block">
      ...
      <div class="about-us__img">
        <img src="<?php the_field('about-us-top-img3'); ?>" alt="">
      </div>
    </div>
  </div>
</section>
