...
<section class="author-top-section">
  <div class="container author-top-section__container">
    <div class="author-top-section__wrap">
      <div class="author-top-section__img"  >
        <?php echo get_avatar(get_the_author_meta('ID')); ?>
      </div>
      <div class="author-top-section__wrapper">
        <h2 class="author-top-section__title">
          Hey there, I’m <?php the_author(); ?> and welcome to my Blog
        </h2>
        <p class="author-top-section__text">
          <?php echo get_the_author_meta('user_description'); ?>
        </p>
        <ul class="social author-top-section__social">
...
<section class="all-posts-section author-page">
  <div class="container all-posts-section__container">
    <h1 class="all-posts-section__title">
      My Posts
    </h1>
    <ul class="all-posts-section__list">
      ...
      <nav class="all-posts-section__nav">
        ...
        <a class="<?php echo ($current_page === $max_page || !($custom_query->have_posts())) ? 'all-posts-section__button' : 'all-posts-section__button all-posts-section__button_active'; ?>" href="<?php echo esc_url($next_page_link); ?>">Next &gt;</a>
      </nav>
    </ul>
  </div>
</section>
